...
class Profile(models.Model):
    ...
    image_profile = models.ImageField(default='default.jpg')

    def __str__(self):
        return f"Profile {self.user.username}"

    def get_image_url(self):
                return self.image_profile.url if self.image_profile else '/media/default.png'
...
class Choose_option(models.Model):
    ...
    def __str__(self):
        return f"User {self.user.username} choose option '{self.option_text}' in vote '{self.option_text.vote.nameVote}'"
